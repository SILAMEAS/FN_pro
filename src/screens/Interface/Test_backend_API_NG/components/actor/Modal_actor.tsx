...
const Api_ng_actor = ({navigation}: any) => {
  const {DATAofActor} = useAppSelector((state) => state.counter);
  console.log('api ----------------');
  console.log(DATAofActor);
  // get Delete file in session
          ...
          <Box justifyContent="space-between">
            <VStack space="2">
              <Text color="white" fontSize="sm">
                Actor ID : {DATAofActor.aid}
              </Text>
              <Text color="white" fontSize="sm">
                Session ID : {DATAofActor.id}
              </Text>
              <Text color="white" fontSize="sm">
              ...
              <Text>
                Roles : [
                {DATAofActor.roles?.map(i => {
                  return <Text key={i}>{i} </Text>;
                })}
                ]
              </Text>
              <Text color="white" fontSize="sm">
                country : {DATAofActor.country}
              </Text>
