...
const config = {
  screens: {
    [Constant_Navigator.NewP_Session]: Constant_Navigator.NewP_Session,
    [Constant_Navigator.NewP_PageDetail]: Constant_Navigator.NewP_PageDetail,
    [Constant_Navigator.NewP_PageScenario]:
      Constant_Navigator.NewP_PageScenario,
    [Constant_Navigator.NewP_ApproveDoc]: Constant_Navigator.NewP_ApproveDoc,
    [Constant_Navigator.NewP_PageGcu]: Constant_Navigator.NewP_PageGcu,
    [Constant_Navigator.NewP_PageGenerateCertificate]:
      Constant_Navigator.NewP_PageGenerateCertificate,
    [Constant_Navigator.NewP_PageSignature]:
      Constant_Navigator.NewP_PageSignature,
